...
validate_recipe_outputs "terraform-provider-docker-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-docker-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi